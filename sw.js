const CACHE='coastcast-v1.3.0';
const CORE=['./','./index.html','./styles.css?v=1.3.0','./app.js?v=1.3.0','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./favicon-32.png','./og-image.png'];
