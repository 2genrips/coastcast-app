# CoastCast v5.0 — Google Play Premium setup

Target subscription: **CoastCast Premium — $4.99/month**.
...
4. The Android wrapper sends the token to the trusted CoastCast backend.
...
7. CoastCast calls `coastcast_my_access()` and unlocks Premium.
