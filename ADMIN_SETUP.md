# CoastCast Owner/Admin setup — Android friendly
...
3. In CoastCast, sign up/sign in under **Profile → CoastCast Account**.
4. In Supabase Dashboard → Authentication → Users, copy your CoastCast account UUID.
5. In SQL Editor run:
...
6. Reopen CoastCast and tap **Refresh server access**.

The **Owner Console** will then appear on your Profile screen. It can grant selected existing CoastCast accounts Complimentary, Lifetime or Promo Premium, or revoke a grant.
